...
public class PurchaseOrderAssetController extends APIController
{
    ...
    public ResponseEntity<Page<? extends ApplicationObject>> getPurchaseOrderAsset(@PathVariable("id") String id,
    ...
    public ResponseEntity<Page<? extends ApplicationObject>> getPurchaseOrderAssets(@RequestHeader String session_id,
                                                                                    Pageable pageRequest,
                                                                                    PersistentEntityResourceAssembler assembler)
    {
